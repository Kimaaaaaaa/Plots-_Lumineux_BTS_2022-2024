...
switch ($request_method) {
    case 'GET': // Si c’est une méthode GET
        ...
        if (!empty($_GET["identifiant$identifiant"])) // Si la propriété identifiant$identifiant existe
        {
            $identifiant = intval($_GET["identifiant$identifiant"]);
            ...
            $reponse = $dataJoueurs->getStatistiquesUnjoueur(); // alors appelle de la méthode getStatistiques()
